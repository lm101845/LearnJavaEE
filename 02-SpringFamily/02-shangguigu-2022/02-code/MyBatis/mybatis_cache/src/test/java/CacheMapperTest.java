...
public class CacheMapperTest {
    ...
    public void testGetEmpById(){
        ...
        //mapper1.insertEmp(new Emp(null,"小灰",25,"男"));
        //执行一次增删改后，会自动清空缓存
        ...
        //System.out.println("emp2--" + emp2);
        //只查了一次数据库
        //创建了多一个sqlSession,则不会从缓存里来拿了
        //原因：sqlSession一级缓存(默认)是sqlSession级别的(即通过同一个sqlSession查询出来的数据会被缓存)
    }
}
